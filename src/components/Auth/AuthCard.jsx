      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-1">Build habits that last</p>
          </div>
          ...
          <div className="space-y-4 mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-xl focus:border-indigo-500 outline-none"
          ...
          <button
            onClick={onAuth}
            disabled={loading}
            className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 rounded-xl font-bold hover:opacity-90 transition mb-4 flex justify-center"
          >
            {loading ? "Processing..." : loginMode === "login" ? "Login" : "Create Account"}
          </button>
